...
/* harmony import */ var _components_add_task_add_task_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/add-task/add-task.component */ "./src/app/components/add-task/add-task.component.ts");
/* harmony import */ var _components_edit_task_edit_task_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/edit-task/edit-task.component */ "./src/app/components/edit-task/edit-task.component.ts");
...
const routes = [
    { path: "", component: _components_main_main_component__WEBPACK_IMPORTED_MODULE_6__["MainComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_7__["AuthGuard"]] },
    { path: "login", component: _components_login_login_component__WEBPACK_IMPORTED_MODULE_3__["LoginComponent"] },
    { path: "register", component: _components_register_register_component__WEBPACK_IMPORTED_MODULE_4__["RegisterComponent"] },
    { path: "main", component: _components_main_main_component__WEBPACK_IMPORTED_MODULE_6__["MainComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_7__["AuthGuard"]] },
    { path: "add-task", component: _components_add_task_add_task_component__WEBPACK_IMPORTED_MODULE_8__["AddTaskComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_7__["AuthGuard"]] },
    { path: "Edit/:id", component: _components_edit_task_edit_task_component__WEBPACK_IMPORTED_MODULE_9__["EditTaskComponent"], canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_7__["AuthGuard"]] },
...
/* harmony import */ var _components_add_task_add_task_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./components/add-task/add-task.component */ "./src/app/components/add-task/add-task.component.ts");
/* harmony import */ var _components_edit_task_edit_task_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./components/edit-task/edit-task.component */ "./src/app/components/edit-task/edit-task.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _components_add_task_add_task_component__WEBPACK_IMPORTED_MODULE_16__["AddTaskComponent"],
            _components_edit_task_edit_task_component__WEBPACK_IMPORTED_MODULE_17__["EditTaskComponent"],
        ],
        imports: [
...
let AddTaskComponent = class AddTaskComponent {
    constructor(taskser, userSER, router, toster) {
    ...
    onAddtask() {
        if (this.name) {
            ...
            this.taskser.saveTask(task).subscribe((resp) => {
...
let EditTaskComponent = class EditTaskComponent {
    constructor(TaskSer, route, router) {
        this.TaskSer = TaskSer;
        this.route = route;
        this.router = router;
    }
    ngOnInit() {
        ...
        this.TaskSer.GetTaskById(this.id).subscribe((data) => {
            if (data.success) {
                this.Task = data.task;
            }
        });
    ...
    onUpdatetask(form, o) {
        ...
        this.TaskSer.PutTaskById(this.id, updatetask).subscribe((data) => {
            if (data.success) {
                this.router.navigate(["/main"]);
            }
        });
...
EditTaskComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./edit-task.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/edit-task/edit-task.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./edit-task.component.css */ "./src/app/components/edit-task/edit-task.component.css")).default]
    })
], EditTaskComponent);
...
let MainComponent = class MainComponent {
    constructor(taskSer, userSER, toaster) {
        this.taskSer = taskSer;
        this.userSER = userSER;
    ...
    deleteTask(id) {
        if (confirm("Are you sure to delete this Task")) {
            this.taskSer.deleteTask(id).subscribe((resp) => {
    ...
    fetchTask() {
        ...
        this.taskSer.getalltask(query).subscribe((resp) => {
            this.task = resp.task;
        });
    }
};
...
let NavbarComponent = class NavbarComponent {
    ...
    ngOnInit() {
        this.user = this.userservice.GetUser().subscribe((data) => {
            if (data) {
                this.name = data.name;
            }
        });
...
module.exports = __webpack_require__(/*! /home/houssem/Bureau/2eme-tour-le-31-03-2019/projetTask/frontEnd/src/main.ts */"./src/main.ts");
